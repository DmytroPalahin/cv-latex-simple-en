...
\vspace{-1pt}
\cvsection{PROJETS INFORMATIQUES}
...
\cvsection{CERTIFICATIONS \& COMPÉTENCES}
...
/*
latexmk -pdf cv-dmytro-palahin-fr-simple.tex
latexmk -pdf -auxdir=/tmp/latex-build -outdir=. cv-dmytro-palahin-fr-simple.tex
pdftoppm -png -r 600 cv-dmytro-palahin-fr-simple.pdf ./img/cv-dmytro-palahin-fr-simple
*/
