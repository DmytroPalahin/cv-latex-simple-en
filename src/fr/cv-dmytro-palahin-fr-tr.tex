...
\begin{minipage}[t]{0.865\textwidth}
    ...
    {\fontsize{8.7pt}{9.6pt}\selectfont
        ...
        Solide formation en \textbf{mathématiques appliquées, probabilités, statistiques,
            optimisation et algorithmique}, complétée par une expérience pratique en
        \textbf{calcul scientifique et traitement de données à grande échelle}.
        Intéressé par la \textbf{finance quantitative, le trading systématique et les stratégies fondées sur les données},
...
\begin{minipage}[t]{0.115\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \node at (0,0) {\includegraphics[width=1.55cm, keepaspectratio]{../../resources/img/photo.png}};
    \end{tikzpicture}
\end{minipage}
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.05em]
    \item Analyse de \textbf{1 an de données opérationnelles} du \textbf{Callbot Zaion}
          ...
          d'évaluer les performances du système et de formuler \textbf{3 recommandations d'amélioration}
    ...
    \item Application d'analyses statistiques et d'approches fondées sur les données afin d'extraire des enseignements
          de jeux de données à grande échelle et d'améliorer les workflows analytiques.

    \item Conception d'un \textbf{système automatisé de migration de SAS Guide vers Python},
          intégrant le traitement de données avec \textbf{Polars et DuckDB},
          le prompt engineering et une \textbf{validation automatisée via une suite de tests à 2 niveaux}
          \begin{itemize}[leftmargin=0.25cm,label=\textendash,itemsep=0em,topsep=0.1em]
              \item \textit{\fontsize{10pt}{9pt}\selectfont Python · Polars · DuckDB · GitHub Copilot · AWS S3}
          \end{itemize}

    \item Conception et automatisation d'un \textbf{pipeline de traitement et de migration de données}
          permettant le transfert de \textbf{500\raisebox{0.20ex}{\small +} Go de jeux de données SAS Guide vers AWS S3}
          et leur mise à disposition des équipes Data
          \begin{itemize}[leftmargin=0.25cm,label=\textendash,itemsep=0em,topsep=0.1em]
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.12em]
    ...
    \item \href{https://github.com/DmytroPalahin/logistics-center-placement}
          {\textbf{Optimisation combinatoire du placement de centres logistiques}} |
          \textit{Python, Julia, CPLEX, MILP} \hfill \textbf{2025}

          Modélisation et résolution d'un problème de localisation de sites par
          \textbf{programmation linéaire en nombres entiers mixtes}, CPLEX et méthodes heuristiques
    ...
    \item \href{https://github.com/DmytroPalahin/Anomaly_Detection}
          ...
          Étude de méthodes de détection d'anomalies et d'étiquetage partiel des données
    ...
    \item \href{https://github.com/DmytroPalahin/Probleme_du_Voyageur_de_Commerce}
          ...
          Implémentation en C d'un algorithme d'optimisation basé sur les \textbf{colonies de fourmis}
    ...
    \item \href{https://github.com/DmytroPalahin/phishing-email-detection}
          ...
          Classification de \textbf{76\,677 e-mails} issus de 5 jeux de données réels à l'aide de
...
\cvevent{\href{https://www.univ-spn.fr}{Université Sorbonne Paris Nord} --- \href{https://www.sup-galilee.univ-paris13.fr/index.php/formation/cp2i/}{Classe préparatoire intégrée de \textbf{Sup Galilée}}}{\fontsize{11pt}{11pt}\selectfont 2021\hspace{5pt}--\hspace{5pt}2023}
% \cvsubevent{}{Villetaneuse, France}
...
\cvtextnotab{
    ...
    Analyse multivariable (dérivées partielles, Jacobienne, Hessienne, développements de Taylor),
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.12em]
    ...
    \item \textbf{Méthodes quantitatives\!:}
          Probabilités, statistiques, modélisation statistique, algèbre linéaire,
          méthodes numériques, optimisation, simulation de Monte-Carlo

    \item \textbf{Machine Learning \& Analyse de données\!:}
          Scikit-Learn, LightGBM, XGBoost, TensorFlow/Keras ·
          Ingénierie des variables, classification, détection d'anomalies,
          évaluation de modèles

    \item \textbf{Marchés financiers \& Trading\!:}
          Forex, actions, futures ·
          Analyse de données de marché, stratégies systématiques, concepts de backtesting,
          gestion du risque, microstructure de marché, carnet d'ordres (L2/L3)

    \item \textbf{Algorithmique \& Informatique\!:}
          Structures de données, complexité algorithmique,
          algorithmes de graphes, programmation parallèle et distribuée, types d'ordres, exécution, VWAP ·
...
\cvsection{\awardIcon[black]\hspace{4pt}DISTINCTIONS \& PARTICIPATIONS}
...
\begin{itemize}[leftmargin=0.35cm, label=\textbullet, itemsep=0.15em]
    ...
    \item \textbf{Eco\hspace{3pt}--\hspace{3pt}Techno Ukraine ISEF} --- 1\textsuperscript{re} place en Informatique \& \textbf{Service Internet d'intelligence collective} --- 1\textsuperscript{re} place en Ukraine
\end{itemize}
...
\vspace{-3pt}
\cvtextnotab{\textbf{Français\!:} Courant \hspace{12pt} \textbf{Anglais\!:} Courant \hspace{12pt} \textbf{Ukrainien\!:} Langue maternelle \hspace{20pt} \textbf{Russe\!:} Bilingue}
...
\cvtextnotab{
    ...
    \flagIcon[black]\hspace{2pt}Karting | Formule 1
}
