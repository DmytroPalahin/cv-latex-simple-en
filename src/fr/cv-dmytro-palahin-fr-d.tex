...
\begin{minipage}[c]{0.11\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \node at (0,0) {\includegraphics[width=1.6cm, keepaspectratio]{../../resources/img/photo.png}};
    \end{tikzpicture}
\end{minipage}
...
\vspace{-4pt}
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    \item \textbf{Langages \& Outils\!:}
          Python, SQL, Java, C/C++, JS/TS, LaTeX ·
          Apache Spark, PySpark, Apache Airflow, dbt, Apache Kafka ·
          Pandas, NumPy, Polars, DuckDB, PostgreSQL, MySQL ·
          Scikit-Learn, TensorFlow, Keras, LightGBM, XGBoost, MLflow ·
          Docker, Git, Linux, AWS, Jupyter, UV, Jira ·
...
/*
latexmk -pdf cv-dmytro-palahin-fr-d.tex
latexmk -pdf -auxdir=/tmp/latex-build -outdir=. cv-dmytro-palahin-fr-d.tex
pdftoppm -png -r 600 cv-dmytro-palahin-fr-d.pdf ./img/cv-dmytro-palahin-fr-d
*/
