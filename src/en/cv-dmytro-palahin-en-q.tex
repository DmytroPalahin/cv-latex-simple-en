...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.12em]
    ...
    \item \textbf{Algorithms \& Computer Science\!:}
          ...
          graph algorithms, parallel and distributed programming

    \item \textbf{Applied Mathematics\!:}
          Linear algebra, probability and statistics, numerical methods, optimization, Monte Carlo simulation

    \item \textbf{Machine Learning\!:}
          Scikit-Learn, LightGBM, XGBoost, TensorFlow/Keras ·
          Data Mining, classification, anomaly detection

    \item \textbf{Financial Markets \& Market Data\!:}
          Forex, equities, futures ·
          Market microstructure, order book (L2/L3), market data,
          liquidity, order types, execution, VWAP ·
...
/*
latexmk -pdf cv-dmytro-palahin-en-q.tex
latexmk -pdf -auxdir=/tmp/latex-build -outdir=. cv-dmytro-palahin-en-q.tex
pdftoppm -png -r 600 cv-dmytro-palahin-en-q.pdf ./img/cv-dmytro-palahin-en-q
*/
