...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.0625em]
    \item Conception d'un \textbf{système automatisé de migration SAS vers Python}
          basé sur \textbf{GitHub Copilot}, intégrant du \textbf{prompt engineering},
          des \textbf{Skills} réutilisables (capacités spécialisées d'agent) et un contexte
          persistant (\texttt{copilot-instructions.md}), validé par une suite de tests à 2 niveaux
    ...
    \item Analyse de données sur les erreurs de reconnaissance du \textbf{Callbot Zaion}
          ...
          \textbf{l'efficacité du système} et d'identifier les causes principales des erreurs,
          conduisant à \textbf{3 recommandations d'amélioration}
          \begin{itemize}[leftmargin=0.25cm,label=\textendash,itemsep=0em,topsep=0.2em]
    ...
    \item Conception et automatisation d'un \textbf{pipeline de migration de données}
          permettant le transfert de \textbf{500\raisebox{0.20ex}{\small +} GB de datasets
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    ...
    \item \href{https://github.com/DmytroPalahin/phishing-email-detection}{\textbf{Système de détection de phishing par email}} | \textit{Python, Machine Learning, NLP} \hfill \textbf{2026}
          ...
          Classification d'emails phishing entraînée sur \textbf{76\,677 emails} (5 datasets réels) via
          un pipeline NLP complet~: TF-IDF, extraction d'URLs, ensemble LightGBM\,+\,Naive Bayes\,+\,LSTM
          %   \begin{itemize}[leftmargin=0.25cm,label=\textendash,itemsep=0em,topsep=0.2em]
    ...
    \item \href{https://github.com/DmytroPalahin/logistics-center-placement}{\textbf{Placement de centres logistiques}} | \textit{Python, Julia, CPLEX, Optimisation} \hfill \textbf{2025}
          ...
          Optimisation du placement de centres logistiques avec modèles MILP, CPLEX et heuristiques
    ...
    \item \href{https://github.com/DmytroPalahin/hsReact}{\textbf{Système de réactions}} | \textit{Haskell} \hfill \textbf{2024}
          ...
          \pdfbookmark[2]{Problème du voyageur de commerce}{salesman}
    ...
    \item \href{https://www.researchsquare.com/article/rs-2203260/v1}{\textbf{Publication de recherche}} | \textit{Algorithmes mathématiques} --- Méthode de filtrage du bruit impulsionnel dans les images vidéo \textit{Informatics and Mathematical Methods in Simulation}, Vol. 11 (2021), No. 4 \hfill \textbf{2021}

          \pdfbookmark[2]{Détection d'anomalies}{anomaly_detection}
    \item \href{https://github.com/DmytroPalahin/Anomaly_Detection}{\textbf{Détection d'anomalies}} Méthodes pour l'étiquetage partiel de données | \textit{Python, Machine Learning} \hfill \textbf{2021}
...
\vspace{-4pt}
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    \item \textbf{Compétences techniques principales\!:} Python, SQL, Linux, Bash, Git, REST APIs, JSON, PostgreSQL, MySQL, Docker, AWS S3, Jupyter, Anaconda, Wireshark, Jira
    \item \textbf{Data \& Automatisation\!:} Pandas, NumPy, Polars, DuckDB, Apache Spark, Scikit-Learn, TensorFlow, LightGBM, XGBoost, Matplotlib, Seaborn, Plotly
    \item \textbf{Connaissances Trading \& Support\!:} MT4/MT5, marchés financiers, Forex, types d'ordres, sessions de marché, concepts d'exécution, gestion du risque, troubleshooting, support de production, analyse de logs, investigation d'incidents, documentation technique
    \item \textbf{Udemy:} \href{https://www.udemy.com/certificate/UC-51319000-ccb8-4c9c-9320-6cd9860e601c/}{\textit{Python for Data Science and Machine Learning Bootcamp}} --- Jose Portilla / Pierian Training
          % \item \textbf{Huawei AI Certifications:} \href{https://github.com/DmytroPalahin/cv-latex-simple-en/blob/main/docs/huawei_artificial_intelligence_and_applications.pdf}{\textit{Artificial Intelligence and Applications}} \hspace{4pt}$\bullet$\hspace{4pt} \href{https://github.com/DmytroPalahin/cv-latex-simple-en/blob/main/docs/huawei_artificial_intelligence_technology_and_applications.pdf}{\textit{Artificial Intelligence Technology and Applications}}
\end{itemize}
...
/*
latexmk -pdf cv-dmytro-palahin-fr-tr.tex
latexmk -pdf -auxdir=/tmp/latex-build -outdir=. cv-dmytro-palahin-fr-tr.tex
pdftoppm -png -r 600 cv-dmytro-palahin-fr-tr.pdf ./img/cv-dmytro-palahin-fr-tr
*/
