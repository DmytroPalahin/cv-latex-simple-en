...
\begin{minipage}[t]{0.865\textwidth}
    ...
    % NAME
    \begin{center}
        {\textbf{\fontsize{15pt}{10pt}\selectfont Dmytro Palahin}}
    \end{center}
    ...
    \begin{center}
        {\fontsize{8.7pt}{10pt}\selectfont
            ...
            \hspace{10pt}
            \href{tel:+33787325878}{
                \phoneIcon[black]\hspace{2pt}+33 7 87 32 58 78
            }
            \hspace{10pt}
            \emailLink[black]{dmytro.palahin@gmail.com}
            \hspace{10pt}
            \linkedinIcon[black]\hspace{2pt}
            \href{https://www.linkedin.com/in/dmytro-palahin/}{Dmytro Palahin}
            \hspace{10pt}
            \githubIcon[black]\hspace{2pt}
            \href{https://github.com/DmytroPalahin}{DmytroPalahin}
        }
    \end{center}
    ...
    {\fontsize{8.7pt}{9.6pt}\selectfont
        Ingénieur en informatique avec \textbf{3 ans d'expérience en Data Engineering,
            Machine Learning et MLOps} chez \textbf{Société Générale Assurances}.
        Solide formation en \textbf{mathématiques appliquées, probabilités,
            statistiques, optimisation et algorithmique}, avec un intérêt pour le
        \textbf{Quantitative Development et Quantitative Research}.
    }
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    ...
    \item \textbf{Programmation \& Algorithmique\!:}
          Python, C/C++, SQL, Java ·
    ...
    \item \textbf{Data Science \& Machine Learning\!:}
          ...
          Scikit-Learn, TensorFlow/Keras, LightGBM, XGBoost ·
          Jupyter, Matplotlib, Seaborn, Plotly

    \item \textbf{Mathématiques appliquées\!:}
          Algèbre linéaire, analyse multivariable,
          probabilités et statistiques, méthodes numériques,
          optimisation linéaire et combinatoire, équations différentielles

    \item \textbf{Marchés financiers\!:}
          Forex, marchés actions et futures, structure de marché,
          types d'ordres, exécution, gestion du risque, MT4/MT5
