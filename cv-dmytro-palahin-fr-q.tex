...
\begin{minipage}[t]{0.865\textwidth}
    ...
    \begin{center}
        ...
        {\textbf{\fontsize{9.5pt}{10pt}\selectfont Quantitative Engineer / Quantitative Developer}}
    \end{center}
    ...
    {\fontsize{8.7pt}{9.6pt}\selectfont
        ...
        Solide formation en \textbf{mathématiques appliquées, probabilités, statistiques,
            optimisation et algorithmique}, complétée par une pratique de
        \textbf{Python, C/C++, calcul scientifique et traitement de données à grande échelle}.
    }
...
\begin{minipage}[t]{0.115\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \node at (0,0) {\includegraphics[width=1.55cm, keepaspectratio]{img/photo.png}};
    \end{tikzpicture}
\end{minipage}
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.05em]
    ...
    \item Conception et automatisation d'un \textbf{pipeline de traitement et migration de données}
          permettant le transfert de \textbf{500\raisebox{0.20ex}{\small +} GB de datasets SAS vers AWS S3}
