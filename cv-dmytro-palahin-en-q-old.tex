...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    ...
    \item \href{https://github.com/DmytroPalahin/Anomaly_Detection}{\textbf{Anomaly Detection}} Methods for partial data labeling | \textit{Python, Machine Learning} \hfill \textbf{2021}
...
\vspace{-4pt}
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    \item \textbf{Core Technical Skills:} Python, SQL, Linux, Bash, Git, REST APIs, JSON, PostgreSQL, MySQL, Docker, AWS S3, Jupyter, Anaconda, Wireshark, Jira
    \item \textbf{Data \& Automation:} Pandas, NumPy, Polars, DuckDB, Apache Spark, Scikit-Learn, TensorFlow, LightGBM, XGBoost, Matplotlib, Seaborn, Plotly
    \item \textbf{Trading \& Support Knowledge:} MT4/MT5, financial markets, Forex, order types, market sessions, execution concepts, risk management, troubleshooting, production support, log analysis, incident investigation, technical documentation
