...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.0625em]
    ...
    \item Développé et déployé \textbf{3 extensions VS-Code} afin de simplifier
          l'utilisation des outils internes de la \textbf{plateforme Data} et d'améliorer
          l'efficacité des workflows pour \textbf{30\raisebox{0.20ex}{\small +}
              utilisateurs}
    ...
    \item Conçu et déployé un \textbf{dashboard de pilotage du Callbot} afin de suivre
          \textbf{10\raisebox{0.20ex}{\small +} KPI opérationnels} et analyser
          l'efficacité pour les équipes internes
          \begin{itemize}[leftmargin=0.25cm,label=\textendash,itemsep=0em,topsep=0.2em]
              \item \textit{\fontsize{10pt}{9pt}\selectfont Apache Superset · PostgreSQL}
          \end{itemize}

    \item \textbf{Analyse de données sur les erreurs de reconnaissance du
              Callbot Zaion} à partir de \textbf{1 an de données opérationnelles} afin
          d’évaluer \textbf{l’efficacité du système} et d’identifier les causes
          principales des erreurs, conduisant à \textbf{3 recommandations d’amélioration}
          \begin{itemize}[leftmargin=0.25cm,label=\textendash,itemsep=0em,topsep=0.2em]
              \item \textit{\fontsize{10pt}{9pt}\selectfont Python · Pandas · NumPy · Matplotlib · Seaborn · Plotly · Jupyter Notebook · Conda}
          \end{itemize}

    \item Conçu et automatisé un \textbf{pipeline de migration de données} permettant de
          transférer \textbf{500\raisebox{0.20ex}{\small +} GB de datasets SAS vers AWS
              S3}, afin d'améliorer la \textbf{scalabilité, l'accès et le traitement des
              données} pour les équipes Data
          \begin{itemize}[leftmargin=0.25cm,label=\textendash,itemsep=0em,topsep=0.2em]
              \item \textit{\fontsize{10pt}{9pt}\selectfont Python · AWS S3 · fsspec · smbfs · Linux · Bash}
          \end{itemize}

    \item Amélioré un \textbf{outil interne de gestion des accès} afin de simplifier
          l'administration des \textbf{droits utilisateurs} pour
    ...
    \item Assuré la \textbf{mise à jour et la maintenance de
              \textbf{35\raisebox{0.20ex}{\small +} extensions internes}} ainsi que des
          \textbf{versions de code-server} afin de garantir la \textbf{stabilité et la
              compatibilité de l’environnement de développement} utilisé par
...
\begin{itemize}[leftmargin=0.35cm, label=\textbullet, itemsep=0.15em]
    \item \textbf{Lauréat de la \href{https://www.fondationbesse.com/}{Fondation Georges Besse}}
