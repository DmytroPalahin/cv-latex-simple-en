...
\cvcourses{Cours\,:}{Méthodes numériques, Structures de données, Probabilités et statistiques, Programmation orientée objet, C/C++, Python, SQL, Data Mining, Web, Complexité, Compilation, Cloud Computing, Cybersécurité, Cryptographie}
