...
\vspace{-4pt}
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    \item \textbf{Languages \& Tools} Python, SQL, JS/TS, Java, C/C++, Haskell, Julia, Matlab, LaTeX · Pandas, NumPy, Scikit-Learn, TensorFlow, LightGBM, XGBoost · Jupyter, Anaconda, Docker, Git, Jira, Linux, Windows, MacOS
