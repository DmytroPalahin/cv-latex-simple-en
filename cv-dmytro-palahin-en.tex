...
\begin{minipage}[c]{0.11\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \node at (0,0) {\includegraphics[width=2.0cm, keepaspectratio]{img/photo.png}};
    \end{tikzpicture}
\end{minipage}
...
\cvcourses{Courses:}{Numerical Methods, Data Structures, Probability and Statistics, Object-Oriented Programming, C/C++, Python, SQL, Data Mining, Web, Complexity, Compilation, Cloud Computing, Cybersecurity, Cryptography}
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.0625em]
    ...
    \item Built internal \textbf{VSCode extensions} (\textbf{TypeScript}) to streamline
          data scientists' workflows on the internal Data Science Platform

    \item Designed \textbf{Callbot performance dashboards} (\textbf{Apache Superset})
          with custom KPIs to track system efficiency and adoption

    \item Analyzed \textbf{Zaion Callbot} recognition errors (\textbf{Python}) by
          comparing operational datasets --- identified root causes and delivered
          improvement recommendations

    \item Built an automated \textbf{data migration pipeline} (\textbf{Python, AWS S3})
          to transfer SAS datasets to cloud storage, improving scalability and access

    \item Improved internal \textbf{credential management} tool (\textbf{Python, JS}) to
          simplify access administration for platform users
...
\cveventitproject{\href{https://github.com/DmytroPalahin/logistics-center-placement}{Logistics Center Placement}}{Python, Julia, CPLEX, Optimization}{2025}
{Combinatorial optimization project on logistics center placement using MILP models solved with CPLEX, greedy heuristics and stochastic local search, with experiments on French city datasets and interactive visualizations}
...
\begin{paracol}{2}
    \begin{leftcolumn}
        ...
        \begin{itemize}[leftmargin=0.25cm, label=\textbullet, itemsep=0.0625em]
            \item \textbf{Huawei:} \href{https://github.com/DmytroPalahin/cv-latex-simple-en/blob/main/docs/huawei_artificial_intelligence_and_applications.pdf}{Artificial Intelligence and Applications}
            \item \textbf{Huawei:} \href{https://github.com/DmytroPalahin/cv-latex-simple-en/blob/main/docs/huawei_artificial_intelligence_technology_and_applications.pdf}{Artificial Intelligence Technology and Applications}
    ...
    \begin{rightcolumn}
        ...
        \begin{itemize}[leftmargin=0.25cm, label=\textbullet, itemsep=0.0625em]
            ...
            \item \textbf{Languages:} Python, C/C++, Java, SQL, HTML, JS/TS, Matlab, Haskell, Julia, LaTeX
...
%----------------------------------------------------------------------------------------
% AWARDS & PARTICIPATIONS / LANGUAGES + INTERESTS
%----------------------------------------------------------------------------------------
\vspace{-10pt}
\columnratio{0.65}
\setlength{\columnsep}{1.2em}
...
\begin{paracol}{2}
    ...
    \begin{leftcolumn}
        ...
        \cvevent{Recipient of the \href{https://www.fondationbesse.com/}{Georges Besse Foundation}}{}

        \vspace{-9pt}
        % \pdfbookmark[2]{Maths \& Physics}{math_compt}
        % \cvevent{Mathematics and Physics Competitions}{}
        ...
        \cvevent{Collective Intelligence Internet Service}{}
    ...
    \begin{rightcolumn}
        ...
        \vspace{-5pt}
        \tradingIcon[black]\hspace{2pt}Trading\hspace{6pt}
        \cryptoIcon[black]\hspace{2pt}Crypto\hspace{6pt}
        \chessIcon[black]\hspace{2pt}Chess\hspace{6pt}
        \skiIcon[black]\hspace{2pt}Skiing\hspace{6pt}
        % \textcolor{black}{\faTableTennis}\hspace{2pt}Tennis\hspace{6pt}
        % \swimmingIcon[black]\hspace{2pt}Swimming
    \end{rightcolumn}
\end{paracol}
...
/*
latexmk -pdf cv-dmytro-palahin-en.tex
