...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.0625em]
    \item Development and deployment of \textbf{3 VS-Code extensions} to simplify the use
          ...
          for \textbf{30\raisebox{0.20ex}{\small +} users}
    ...
    \item Design and deployment of a \textbf{Callbot monitoring dashboard} to track
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    ...
    \item \href{https://www.researchsquare.com/article/rs-2203260/v1}{\textbf{Publication of an article}} | \textit{Mathematical Algorithms} \hfill \textbf{2021}

          Method of pulse noise filtration in video images (D.Palahin, V.Palahin,
          O.Zorin, O.Hozhyi)\newline\textit{Informatics and Mathematical Methods in
              Simulation}, Vol. 11 (2021), No. 4
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    ...
    \item \textbf{Languages \& Tools} Python, C/C++, Java, SQL, HTML, JS/TS, Matlab, Haskell, Julia, LaTeX, VSCode, Jupyter, Anaconda, Git, Docker, Linux, Windows, MacOS
\end{itemize}
...
\vspace{-3pt}
\cvtextnotab{\textbf{Ukrainian\!:} Native \hspace{20pt} \textbf{Russian\!:} Bilingual \hspace{12pt} \textbf{French\!:} Fluent \hspace{12pt} \textbf{English\!:} Fluent}
