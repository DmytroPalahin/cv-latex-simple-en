...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    ...
    \item \href{https://www.researchsquare.com/article/rs-2203260/v1}{\textbf{Publication d'un article}} | \textit{Algorithmes mathématiques} \hfill \textbf{2021}

          Méthode de filtration du bruit impulsionnel dans les images vidéo (D.Palahin,
          V.Palahin, O.Zorin, O.Hozhyi)\newline\textit{Informatics and Mathematical
              Methods in Simulation}, Vol. 11 (2021), No. 4
...
\begin{itemize}[leftmargin=0.5cm, label=\textbullet, itemsep=0.2em]
    ...
    \item \textbf{Langages \& Outils} Python, C/C++, Java, SQL, HTML, JS/TS, Matlab, Haskell, Julia, LaTeX, VSCode, Jupyter, Anaconda, Git, Docker, Linux, Windows, MacOS
\end{itemize}
...
\vspace{-3pt}
\cvtextnotab{\textbf{Ukrainien\!:} Natif \hspace{20pt} \textbf{Russe\!:} Bilingue \hspace{12pt} \textbf{Français\!:} Courant \hspace{12pt} \textbf{Anglais\!:} Courant}
